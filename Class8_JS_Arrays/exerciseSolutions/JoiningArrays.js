...
function joinArrayToString(array, separator) {
  ...
  console.log(joinWithShiftedElement([1, 2], [3, 4], '-')); // Expected output: "2-1-4-3"
  console.log(joinWithShiftedElement(['a', 'b'], ['c', 'd'], '')); // Expected output: "badc"
  ...
  console.log(concatWithPoppedElement([1, 2, 3], [4, 5, 6])); // Expected output: [1, 2, 3, 4, 5]
  console.log(concatWithPoppedElement(['a', 'b', 'c'], ['d', 'e', 'f'])); // Expected output: ['a', 'b', 'c', 'd', 'e']
  console.log(concatWithPoppedElement([true, false, false], [true, false, true])); // Expected output: [true, false, false, true, false]
  ...
  console.log(joinAndUnshift([1, 2], [3, 4], '-', 0)); // Expected output: "0-1-2-3-4"
  console.log(joinAndUnshift(['a', 'b'], ['c', 'd'], '', 'z')); // Expected output: "zabcd"
  console.log(joinAndUnshift([true, false], [false, true], ', ', null)); // Expected output: ", true, false, false, true"
